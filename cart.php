...
<body>
    <div id="container">
            ...
            <div id="content">
                ...
                <div id="content_4" onclick="content4Click()">
                    <h5>Click anywhere to enter</h5>
                    <img width="20%" src="assets/images/nike_PNG4.png"></a>		
                </div>
                <img style="position:absolute;bottom:25px;right:0;"width="10%" 
                    src="assets/images/nike_PNG9.png">
            </div>
